...
def main():
    ...
    initial_pose.pose.position.x = 1.00867
    initial_pose.pose.position.y = -0.489365
    initial_pose.pose.orientation.z = -0.100801
    initial_pose.pose.orientation.w = 0.994907
    ...
    while not navigator.isTaskComplete():
        ...
        if feedback and i % 5 == 0:
            ...
            # Print feedback object to determine available attributes
            print(feedback)

        # Placeholder for recovery status check, will replace after inspecting feedback
        # if feedback and feedback.some_attribute == "Attempting backup":
        #     print('Attempting backup detected, initiating spin...')
