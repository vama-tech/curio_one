...
class SensorPublisher(Node):
    def __init__(self):
        ...
        self.publisher_ = self.create_publisher(LaserScan, '/range_2', 10)
    ...
    def dynamic_joint_states_callback(self, msg):
        for interface_value in msg.interface_values:
            if 'Sensor2' in interface_value.interface_names:
                ...
                scan_msg.header.frame_id = 'tof_2'  # Set appropriate frame ID
...
#     def __init__(self):
#         super().__init__('sensor_publisher')
#         self.get_logger().info("Started Range 3 Node")
...
#                 range_msg.header.frame_id = 'tof_2'  # Set appropriate frame ID
